  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        rockPage.routeName : (context) => const rockPage(),
        popPage.routeName : (context) => const popPage(),
        indiePage.routeName : (context) => const indiePage(),
        hiphopPage.routeName : (context) => const hiphopPage(),
        musicDetailPage.routeName : (context) => const musicDetailPage(),
